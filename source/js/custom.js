...
console.log(path);
if(path !== 'https://blog.zhheo.com/null'){
...
function showconsolebtn() {
  ...
  var bobtns = document.getElementById('bottombtns');
  if (consolebtn.style.right === '0px') {
    consolebtn.style.right = '-40px';
    consolebtn.style.bottom = '-205px';
    bobtns.style.bottom = '0'
    bobtns.style.right = '0'
  } else {
    consolebtn.style.right = '0px'
    consolebtn.style.bottom = '0px';
    bobtns.style.bottom = '205px'
    bobtns.style.right = '35px'
  }
}
...
const box = document.querySelector('#consolebtn')
    ...
    var ele = document.querySelector('#consolebtn');
    // 记录的是元素当前位置
